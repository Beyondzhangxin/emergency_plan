	...
	<div class="contentbox">
        ...
        <table class="formtable" border="0" cellpadding="0" cellspacing="0" width="95%">
            <tr>
                ...
                <td width="30%">
                    <input type="text" class="txtinput"  id="planName" name="planName" value="${emplan.planName }">&nbsp;<span id="planName_msg" style="color: red"></span>
                </td>
            ...
            <tr>
                ...
                <td width="30%">
                	<input type="file" name="fileContent"  id="fileContent" value="${emplan.fileName}">&nbsp;<span id="fileContent_msg" style="color: red"></span><a href="download.do?planId=${emplan.planId}" class="link_tbdw">${emplan.fileName}</a>
                </td>
            </tr>
        </table>
        </form>
