...
<script>
    function edit() {
        ...
        if (editId.length == 1) {
            window.open("../em_drill/detail.do?drillId=" + editId);
        } else {
            alert("请选择一条数据进行编辑")
        }
    }
    function deleteItems() {
        var flag = false;
        for (i = 0; i < frmList.drillId.length; i++) {
            if (frmList.drillId[i].checked) {
                flag = true;
                break;
            }
        }
...
<p class="content_head_form">
    ...
    <span class="btnbox">
           <a class="btn2 btn_add" href="../em_drill/detail.do" target="_blank">添加</a>
...
<div class="tablebox" id="tablebox">
    <jsp:include page="/em_drill/table.do"></jsp:include>
</div>
